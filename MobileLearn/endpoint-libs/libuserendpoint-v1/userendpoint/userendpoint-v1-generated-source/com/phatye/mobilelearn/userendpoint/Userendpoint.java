...
package com.phatye.mobilelearn.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "confirmUser".
   *
   * This request holds the parameters needed by the the userendpoint server.  After setting any
   * optional parameters, call the {@link ConfirmUser#execute()} method to invoke the remote
   * operation.
   *
   * @param userEmail
   * @param password
   * @return the request
   */
  public ConfirmUser confirmUser(java.lang.String userEmail, java.lang.String password) throws java.io.IOException {
    ConfirmUser result = new ConfirmUser(userEmail, password);
    initialize(result);
    return result;
  }

  public class ConfirmUser extends UserendpointRequest<com.phatye.mobilelearn.userendpoint.model.User> {

    private static final String REST_PATH = "confirmUser/{userEmail}/{password}";
     ...
     * optional parameters, call the {@link ConfirmUser#execute()} method to invoke the remote
     * operation. <p> {@link
     * ConfirmUser#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     ...
     * @since 1.13
     */
    protected ConfirmUser(java.lang.String userEmail, java.lang.String password) {
      super(Userendpoint.this, "POST", REST_PATH, null, com.phatye.mobilelearn.userendpoint.model.User.class);
    ...
    @Override
    public ConfirmUser setAlt(java.lang.String alt) {
      return (ConfirmUser) super.setAlt(alt);
    }

    @Override
    public ConfirmUser setFields(java.lang.String fields) {
      return (ConfirmUser) super.setFields(fields);
    }

    @Override
    public ConfirmUser setKey(java.lang.String key) {
      return (ConfirmUser) super.setKey(key);
    }

    @Override
    public ConfirmUser setOauthToken(java.lang.String oauthToken) {
      return (ConfirmUser) super.setOauthToken(oauthToken);
    }

    @Override
    public ConfirmUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ConfirmUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ConfirmUser setQuotaUser(java.lang.String quotaUser) {
      return (ConfirmUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public ConfirmUser setUserIp(java.lang.String userIp) {
      return (ConfirmUser) super.setUserIp(userIp);
    }
    ...
    public ConfirmUser setUserEmail(java.lang.String userEmail) {
    ...
    public ConfirmUser setPassword(java.lang.String password) {
      this.password = password;
      return this;
    }

    @Override
    public ConfirmUser set(String parameterName, Object value) {
      return (ConfirmUser) super.set(parameterName, value);
    }
  }
  ...
  public class GetUser extends UserendpointRequest<com.phatye.mobilelearn.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.phatye.mobilelearn.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.phatye.mobilelearn.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.phatye.mobilelearn.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.phatye.mobilelearn.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.phatye.mobilelearn.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.phatye.mobilelearn.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.phatye.mobilelearn.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.phatye.mobilelearn.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.phatye.mobilelearn.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.phatye.mobilelearn.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.phatye.mobilelearn.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.phatye.mobilelearn.userendpoint.model.User.class);
    }
